...
export default function Hero({ actualLocationName }) {
  return (
    <section className={styles.hero}>
      <div className="container">
        <h1>{`<${actualLocationName} page>`}</h1>
        <p className="hero__label">Hi, I’m Maciek</p>
        <h1 className="hero__title">
          A <span className="highlight">creative developer</span> crafting
